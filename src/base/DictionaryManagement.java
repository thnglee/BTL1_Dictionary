...
public class DictionaryManagement {
    ...
    public static void main(String[] args) {
        ...
        String[] arr = { "Translate sentence using GGAPI", "Add a new word to My Star Words", "Set the star word", "Show all Words in Dictionary",
                "Show all My Star Words", "Remove word from Dictionary", "Remove word from My Star Word", "Search",
                "Connect Word From Database", "Import From File", "Export to file" };
        ...
        while (true) {
            ...
            if(action == 0){
                ...
                // Game
                try {
                    DataBaseConnect.GetWordFromData();
                } catch (Exception e) {
